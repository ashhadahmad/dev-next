      ...
      <div className="w-full lg:max-w-5xl mx-auto box-border">
        <div className="px-4 lg:px-0 w-full lg:max-w-5xl text-base lg:text-xl box-border flex flex-col gap-6">
          ...
          <ul className="flex gap-4 py-4 text-base lg:text-xl">
            <li className="flex-1 border-2 flex items-center border-gray-50/10 rounded-md p-1 text-center">
              <span>
                There's <span className="font-bold">so much</span> to learn. So
                many{" "}
          ...
          <div className="text-base lg:text-xl font-medium">
            If you've felt the same, You are not alone. Learning how to code can
            be{" "}
          ...
          <p className="text font-medium">
            ...
            <Icon className="inline mx-2" height="1.1rem" icon="logos:google" />
            and
            <Image
          ...
          <span className="flex flex-row items-center align-middle">
            ...
            <Image width={100} height={100} src={NoBS} alt="no bullshit" /> .
